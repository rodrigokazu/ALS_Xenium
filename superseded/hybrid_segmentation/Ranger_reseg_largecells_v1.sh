...
# ========================================================================================
# ALS_Xenium repo commentary | superseded/hybrid_segmentation/Ranger_reseg_largecells_v1.sh
#
# The first large-cell re-segmentation submission, before it was generalised into the array
# job now in segmentation/run_xenium_array.sh.
#
# Resources match its successor at 16 CPUs, 256G and 72 hours, and so does the intent: recover
# motor neuron somata that default segmentation cuts up or drops. This version handles one
# sample at a time with the paths written in.
#
# It documents when the large-cell approach entered the project. Use the array version for
# anything new.
# ========================================================================================
