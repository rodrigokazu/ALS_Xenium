#!/usr/bin/env python3
# ========================================================================================
# ALS_Xenium repo commentary | deconvolution/DOTpy_ventral_horn.py
#
# The same deconvolution restricted to a ventral horn subset, so the motor neuron
# neighbourhood can be examined without the rest of the cord dominating the fit.
#
# Identical parameters to the full-section version. Change the input and nothing else, and any
# difference in the labels belongs to the region instead of the settings.
#
# Lower memory ceiling and a shorter walltime in its runner, reflecting the smaller input.
# ========================================================================================

"""
DOTpy non-neuronal deconvolution — ventral horn subset.
...
SPATIAL_H5AD = Path(
    "/oak/stanford/scg/lab_mpsnyder/johnck/Projects/RK/Spatial/DOT/(RK)SC_ventral_horn_v4.h5ad"
)
OUT_ROOT = Path(
    "/oak/stanford/scg/lab_mpsnyder/johnck/Projects/RK/Spatial/DOT/DOTpy_ventral_horn"
)
