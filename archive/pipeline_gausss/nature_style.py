# ========================================================================================
# ALS_Xenium repo commentary | archive/pipeline_gausss/nature_style.py
#
# A copy of the plotting helpers, kept here so this directory imports without reaching into
# ck_spatial_pipeline. Every script in this folder does a bare 'import nature_style', which
# resolves against its own directory, and splitting the two would break all of them.
#
# The file is byte-identical to ck_spatial_pipeline/common/nature_style.py. If you change one, change
# both, or accept that figures from the two generations stop matching.
# ========================================================================================
