# ========================================================================================
# ALS_Xenium repo commentary | pipeline_gausss/nature_style.py
#
# A copy of the plotting helpers, kept here so this directory imports without reaching into
# pipeline_final. Every script in this folder does a bare 'import nature_style', which
# resolves against its own directory, and splitting the two would break all of them.
#
# The file is byte-identical to pipeline_final/nature_style.py. If you change one, change
